...
public class Testumgebung
{
    public static void main( String args[] )
    {
        ...
        // Beispiel 1
        Fraction[] arr1 = { new Fraction(1,2), new Fraction(1,2), new Fraction(1,2), new Fraction(1,5), new Fraction(1,10), new Fraction(1,1) };
        Fraction f1 = new Fraction(1,2);
        System.out.println( Testat.apply( arr1, f1, 5 ).toString() );

        //Beispiel 2
        Fraction[] arr2 = { new Fraction(1,3), new Fraction(11,6), new Fraction(1,1), new Fraction(1,3), new Fraction(1,3) };
        Fraction f2 = new Fraction(1,3);
        System.out.println( Testat.apply( arr2, f2, 4 ).toString() );
        
        //Beispiel 3
        Fraction[] arr3 = { new Fraction(2,1), new Fraction(1,2), new Fraction(8,7) };
        Fraction f3 = new Fraction(1,2);
        System.out.println( Testat.apply( arr3, f3, 2 ).toString() );
        
        //Beispiel 4
        Fraction[] arr4 = { new Fraction(1,2) };
