...
public class Testumgebung {
    ...
    public static void test()
    {
        ...
        System.out.print( "Liste vor Aufruf von apply( 3 ):   " );
        dll2.showAll();
        dll2.apply( 3 );
        System.out.print( "Liste nach Aufruf von apply( 3 ):  " );
        dll2.showAll();
        ...
        System.out.print( "Liste vor Aufruf von apply( 0 ):   " );
        dll4.showAll();
        dll4.apply( 0 );
        System.out.print( "Liste nach Aufruf von apply( 0 ):  " );
        dll4.showAll();
